...
namespace WebApiEntityFramework.Seeding
{
    public static class ModelSeeder
    {
        public static void Seed(ModelBuilder builder)
        {
            ...
            builder.Entity<Genre>().HasData(action, animation, comedy, scienceFiction, drama);
            ...
            builder.Entity<Cinema>().HasData(agora, sambil, megacentro, acropolis);
            ...
            builder.Entity<CinemaOffer>().HasData(acropolisOffer, agorraOffer);
            ...
            var cinemaHall2DAgora = new CinemaHall()
            {
                ...
                CinemaId = agora.Id,
                Cost = 220,
                Type = CinemaHallType.TwoDimensions
            };
            var cinemaHall3DAgora = new CinemaHall()
            {
                ...
                CinemaId = agora.Id,
                Cost = 320,
                Type = CinemaHallType.ThreeDimensions
            };
            ...
            builder.Entity<CinemaHall>().HasData(cinemaHall2DMegacentro, cinemaHall3DMegacentro, cinemaHallCXCMegacentro, cinemaHall2DAcropolis, cinemaHall2DAgora, cinemaHall3DAgora, cinemaHall2DSambil, cinemaHall3DSambil);
            ...
            builder.Entity(entityGenreMovie).HasData(
            ...
            builder.Entity(entityCinemaHallMovie).HasData(
            ...
            builder.Entity<Movie>().HasData(avengers, coco, noWayHome, farFromHome, theMatrixResurrections);

            builder.Entity<MovieActor>().HasData(samuelJacksonFFH, tomHollandFFH,
            ...
            builder.Entity<Person>().HasData(felipe, claudia);
