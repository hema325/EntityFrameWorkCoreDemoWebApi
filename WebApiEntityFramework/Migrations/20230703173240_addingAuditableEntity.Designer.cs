...
namespace WebApiEntityFramework.Migrations
{
    ...
    [Migration("20230703173240_addingAuditableEntity")]
    partial class addingAuditableEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiEntityFramework.Entities.CinemaDetail", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");

                    b.Property<string>("CodeOfCoduct")
                        .IsRequired()
            ...
            modelBuilder.Entity("WebApiEntityFramework.Entities.Actor", b =>
                {
                    b.OwnsOne("WebApiEntityFramework.Entities.Address", "BillingAddress", b1 =>
                        {
                    ...
                    b.OwnsOne("WebApiEntityFramework.Entities.Address", "HomeAddress", b1 =>
                        {
                            b1.Property<int>("ActorId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiEntityFramework.Entities.Cinema", b =>
                {
                    b.OwnsOne("WebApiEntityFramework.Entities.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("WebApiEntityFramework.Entities.CinemaDetail", b =>
                {
                    b.HasOne("WebApiEntityFramework.Entities.Cinema", "Cinema")
                        ...
                        .HasForeignKey("WebApiEntityFramework.Entities.CinemaDetail", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
